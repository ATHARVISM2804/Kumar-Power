      ...
      <section className="bg-black text-white py-16 h-80">
        <div className="max-w-7xl mx-auto px-8">
          <div className="mb-6">
            ...
            <button className="text-blue-400 mt-4 flex items-center text-sm">
              Discover
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mt-16">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <button className="bg-white text-black py-2 px-6 rounded flex items-center">
            ...
            <div className="flex justify-center gap-6 mt-8">
              <a href="https://wa.me/917023817174" className="flex items-center text-sm">
                <div className="bg-green-600 h-8 w-8 rounded-full flex items-center justify-center mr-2">
              ...
              <a href="tel:01123911273" className="flex items-center text-sm">
                <div className="bg-blue-600 h-8 w-8 rounded-full flex items-center justify-center mr-2">
